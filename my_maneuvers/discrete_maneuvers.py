...
if __name__ == "__main__":
    ...
    while curr_move != 'end':
        ...
        if curr_move == 'end':
            ...
            speed = float('Please enter a desired speed (-ve for backwards)')
            angle = float('Please enter a desired turning angle')
            duration = float('Please enter a desired duration')
